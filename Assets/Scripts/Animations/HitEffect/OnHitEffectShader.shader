Shader "Custom/ECS_QuadSpriteOnHitEffect"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
                UNITY_DOTS_INSTANCED_PROP_OVERRIDE_REQUIRED(float4, _Color)
                UNITY_DOTS_INSTANCED_PROP_OVERRIDE_REQUIRED(float, _Fade)

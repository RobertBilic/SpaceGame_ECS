...
{
    public struct RangeBasedTargetingCollectorSingle : ISpatialQueryCollector
    {
        public RangeBasedTargetingCollectorSingle(EntityManager manager, float3 position, float range, int team)
        {
            this.em = manager;
